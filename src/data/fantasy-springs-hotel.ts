...
import { AVAILABILITY_TOTAL, RATE_SOURCE, rateFor } from '~/data/fsh-rates';
...
export const VIEWS: RoomView[] = [
  {
    ...
    summary: '正面對著夢幻泉鄉',
    detail:
      '官方定義是「可由正面瞭望夢幻泉鄉的客房」。只出現在泉鄉區，也就是直接面向園區的那一側，全部是 50 平方公尺、人數上限 5 位的尊爵客房。這一級是這間飯店最貴的房間。',
  },
  {
    key: 'park',
    label: '樂園景觀',
  ...
  },
  {
    ...
    detail:
      '官方定義寫得很白：「可瞭望夢幻泉鄉的客房，但部分視野會受到建築物阻擋。」位置在泉鄉區，房間規格和樂園全景觀完全一樣，便宜的是窗外。',
  },
  {
    key: 'none',
    label: '無景觀指定',
...
export const FACILITIES: Facility[] = [
  ...
  },
  {
    ...
    description:
      '館內商店，賣飲料、零食等日用品，也有尿布與嬰兒食品。飯店裡不賣紀念商品——住宿遊客限定的迪士尼飯店獨家商品要進園區買。',
  },
  {
    name: '住宿遊客洗衣室',
...
export const BENEFITS: Benefit[] = [
  ...
  {
    title: '歡樂入園',
    description: '比一般遊客提前從專用入園口進入適用園區。使用這個禮遇時同樣可以走專用的園區入口。',
    caveat: '需要園區票券。適用的園區依住宿飯店而不同；提前的分鐘數在官方頁面上沒有寫。',
  },
  {
  ...
  },
  {
    title: '在飯店買園區票券',
    description:
      '官方網站的票券售完時，住宿遊客仍然可以在飯店買到住宿期間的票券。夢幻館在行李服務櫃檯（6:00–22:00），豪華館在豪華館接待廳（7:00–22:00）。',
    caveat: '假期套票已含票券的話，票面記載的入園日不能加購。目前沒有販售特別連日護照。',
  },
  {
    title: '免費行李遞送到飯店',
    description:
...
export const FAQS: Faq[] = [
  ...
  },
  {
    ...
    answer:
      '想從專用入口離開園區的話，21:00 前要回到夢幻泉鄉，2026 年 6 月 19 日～9 月 14 日期間是 21:10。這是「回到夢幻泉鄉」的時間，不是通過閘門的時間；另外依娛樂表演時間，有時候不能從這裡出園。',
  },
  {
    question: '這間飯店怎麼才訂得到？',
    answer:
