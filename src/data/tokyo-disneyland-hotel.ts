...
export const VIEWS: RoomView[] = [
  {
    ...
    summary: '正面對著東京迪士尼樂園',
    detail:
      '官方定義是「可由正面瞭望東京迪士尼樂園的客房」。窗外由近到遠依序是迪士尼度假區線車站、世界市集屋頂、灰姑娘城堡。全部位在 5 樓以上。',
  },
  {
    key: 'park',
    label: '樂園景觀',
    ...
    detail:
      '官方定義是「可瞭望東京迪士尼樂園的客房」，位置比全景觀偏側面。城堡會在斜前方，煙火大致看得到但構圖沒那麼完整。價差通常比全景觀便宜約 8,500 日圓，是最務實的選擇。',
  },
  {
    key: 'none',
    label: '無景觀指定',
...
export const BED_SPECS: BedSpec[] = [
  ...
  },
  {
    ...
    size: '100 × 190 × 27 cm',
    capacity: '1 位',
    note: '平常收在標準床底下，拉出來就能用。床面低，適合兒童。',
  },
  {
    name: '郵輪床',
    nameJa: 'クルーズベッド',
...
export const DINING: Dining[] = [
  {
    ...
    seats: '298 席',
    description:
      '面向雪伍德花園的大片落地窗自助餐廳，日式與西式都有，並設有兒童專用的低檯面自助餐檯。',
...
export const BENEFITS: Benefit[] = [
  {
    ...
    description:
      '比一般遊客早 15 分鐘入園，兩座樂園都適用。入園需同時出示入住時發放的通行證與門票。',
    caveat: '入住當天不適用，只有住宿期間的隔天與退房當天可以用。',
  },
  {
    title: '免費行李遞送到飯店',
    description:
      '受理地點是迪士尼飯店服務台（迎賓中心 2 樓），服務時間 7:30–16:00，免費。',
  },
  {
    title: '回程行李遞送到車站',
    description:
      '受理 7:00–12:30，13:00 後於迎賓中心 2 樓領取。每件 800 日圓。',
    caveat: '領取截止時間官方頁面不一致：飯店頁寫 20:00、迎賓中心頁寫 21:00。',
  },
  {
    title: '飯店限定客房備品',
...
export const FAQS: Faq[] = [
  {
    ...
    answer:
      '不用。樂園景觀也看得到，只是角度偏斜，價格便宜約 8,500 日圓。要避開的是沒有景觀標註的房型，那些完全看不到。',
  },
  {
    question: '可以指定樓層或房號嗎？',
    answer:
      '不行。分類涵蓋整個樓層區間（例如樂園景觀是 3–8 樓），也不接受指定房號。只能在備註欄寫「希望高樓層」，但沒有保證。',
  },
  {
    question: '迪士尼明星房看得到樂園嗎？',
    answer:
      '九種明星房型都沒有景觀標註，官方寫的是面向飯店正門、附註「部分客房除外」。想確保看得到樂園，就得放棄主題房。',
  },
  {
    question: '訂房什麼時候開賣？',
    answer:
      '住宿日的 4 個月前同日上午 11:00（日本時間），一次最多 5 晚、3 間房。',
  },
  {
    question: '禮賓房值得加價嗎？',
    answer:
      '四人入住通常值得，因為含翌日早餐；兩人又不打算待在飯店的話，那筆錢換成正面景的標準房比較划算。',
  },
  {
    question: '從舞濱車站怎麼走過去？',
    answer:
      '南口出站右轉，步行約 8 分鐘。也可以搭迪士尼度假區線到第一站「東京迪士尼樂園站」。',
  },
  {
    question: '哪幾個月最貴、哪幾個月最便宜？',
    answer:
      '6 月整月最便宜，最貴的日期也只比全年最低價高三成。11、12 月兩端都貴。7 到 9 月有全年最便宜的日期，但同月也有貴到六成的日期，要挑日子。',
  },
];
