...
export const CATEGORIES: RoomCategory[] = [
  ...
  },
  {
    ...
    label: '禮賓房',
    labelEn: 'Concierge',
    summary: '含專用貴賓室（馬瑟琳沙龍）與翌日早餐，在專屬櫃檯辦理入住。',
...
export const ROOMS: Room[] = [
  ...
  },
  {
    ...
    note: '陽台不是這個房型的標配，2026 年 4 月起無法指定樓層，別把它當成必得的條件。',
  },
  {
    id: 'std-family-pv',
    name: '家庭客房（樂園景觀）',
...
export const FACILITIES: Facility[] = [
  ...
  },
  {
    ...
    description:
      '3 歲到小學六年級的孩子可以變身成迪士尼公主的沙龍。飯店店限定可以選仙杜瑞拉、愛麗兒、貝兒、樂佩、安娜、艾莎。',
    photoTip:
  ...
  },
  {
    ...
    location: '禮賓房專用貴賓室',
    description:
      '禮賓房與套房住客的專屬空間，入住手續在這裡辦，不用排大廳的隊。一天之中會提供不同時段的輕食與飲料。',
  },
];
...
export const DINING: Dining[] = [
  {
    ...
    reservation: '可線上申請優先入座（Priority Seating）',
  },
  {
    name: '卡納',
    nameEn: 'Canna',
    ...
    description:
      '以美人蕉為設計主題的紅色現代空間，主題是「健康與美麗」的創作料理，以套餐形式供應。不供應早餐，是飯店裡最安靜的一家。',
    reservation: '可線上申請優先入座，部分菜單為事先預約制',
  },
  {
    name: '夢想家酒廊',
    ...
    description:
      '大廳旁明亮開放的酒廊，下午茶、輕食與調酒都在這裡。禮賓房住客的早餐有時會安排在這一間而不是雪伍德花園。',
    reservation: '套餐為事先預約制，需於官方線上預約網站申請',
  },
];
...
export const BENEFITS: Benefit[] = [
  ...
  },
  {
    title: '回程行李遞送到車站',
    description:
      '退房後把行李交給飯店的行李服務櫃檯（受理 7:00–12:30），下午再到迎賓中心 2 樓領取。2026 年 4 月起領取時間延長到 21:00。',
...
export const SOCIAL_INSIGHTS: SocialInsight[] = [
  ...
  {
    platform: 'TikTok',
    headline: '房內看夜間表演：雷射很強，投影和音樂會失望',
    body: '住客實測「Reach for the Stars」的雷射從房間看非常有魄力，煙火與無人機以位置關係來說也看得到。但灰姑娘城堡的投影映射會被前方建築擋住城堡下半部，音樂幾乎聽不見，等於是在看無聲版。',
    verdict: '想完整看投影秀就得進園。房內版本的價值在於「看完就能直接躺下」，而不是畫面完整。',
  },
  {
    platform: 'Instagram',
  ...
  {
    platform: 'Instagram',
    headline: '戶外三個打卡點走完不用十分鐘',
    body: '幻想曲廣場的魔法師米奇噴泉、愛麗絲花園的撲克牌植栽、米奇友誼廣場的樹雕，三個點彼此走路都在一分鐘內。搭電車的人容易整趟都沒繞到飯店正門那一側，直接錯過米奇噴泉。',
    verdict: '安排在退房後、進園前的空檔剛好。早上八點前光線好、人也最少。',
  },
  {
    platform: 'TikTok',
  ...
  {
    platform: '部落格',
    headline: '撿取消房是這間飯店的常識，不是偏方',
    body: '不只客房，餐廳的優先入座也一樣。多位住客都提到官方網站會陸續釋出被取消的名額，訂房當下沒搶到想要的時段，接下來每天固定回去看反而更容易補到。',
    verdict: '把官方訂房頁面加到書籤，出發前每天掃一次。這件事的投報率高過任何訂房技巧。',
  },
];
...
export const FAQS: Faq[] = [
  {
    ...
    answer:
      '不一定。樂園景觀也看得到，只是角度偏斜、構圖沒那麼完整，價格便宜約 8,000 到 10,000 日圓。真正必須避開的是沒有標註景觀的房型，那些窗外是中庭或正門側，完全看不到。',
  },
  {
    question: '可以指定樓層或房號嗎？',
    answer:
      '不行。2026 年 4 月 1 日起飯店取消了原本依樓層區分的客房分類，價格也一律化，所以連「7–8 樓」這種區間都選不到了。官方也不接受指定房號。可以做的只有在訂房備註欄寫「希望高樓層」，飯店會視當天狀況盡量配合，但沒有保證。',
  },
  {
    question: '迪士尼明星房看得到樂園嗎？',
    answer:
      '看不到。官方明確說明迪士尼明星房面向飯店正門側，禮賓房的迪士尼仙履奇緣客房也一樣。想要主題房又想要景觀的話，這兩件事在這間飯店無法同時成立，只能二選一。',
  },
  {
    question: '訂房什麼時候開賣？',
    answer:
      '純住宿的預約在住宿日的 4 個月前同日上午 11:00（日本時間）開放，一次最多可訂 5 晚。如果該月沒有對應日期，會順延到下個月 1 日的 11:00 開放。',
  },
  {
    question: '禮賓房值得加價嗎？',
    answer:
  ...
  },
  {
    question: '從舞濱車站怎麼走過去？',
    answer:
      'JR 舞濱車站南口出來右轉，經過「迪士尼一路順風」商店後繼續往樂園方向走，約 8 分鐘。也可以在車站旁的度假區總站搭迪士尼度假區線，第一站「東京迪士尼樂園站」下車，車站就在飯店與樂園之間。從飯店走到樂園正門入口只要 1 分鐘。',
  },
  {
