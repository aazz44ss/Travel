...
const en: ExplorerCopy = {
  ...
  harbourPlan: {
    ...
    facing: {
      ...
      canal: 'Palazzo Canals side',
      entrance: 'Park entrance side',
      spa: 'Terme Venezia and pool side',
    },
    shows: {
